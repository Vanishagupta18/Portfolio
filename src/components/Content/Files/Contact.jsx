            ...
            <div className="terminal-container">
              ...
              <div className="terminal-body">
                ...
                <div className="terminal-line">
                  <span className="prompt-user">Vanisha@DESKTOP-12345 ~ $</span>
                </div>

                <div className="terminal-line">
                  <span className="prompt-command">{"> whoami"}</span>
                </div>
                <div className="terminal-output">Vanisha Gupta</div>
                ...
                <div className="terminal-output">
                  ...
                  <a href="mailto:guptaVanisha2308@gmail.com">
                    guptavanisha11@gmail.com
                  </a>
                </div>
                <div className="terminal-output">
                  <span className="icon">🌐</span>{" "}
                  <a
                    href="https://www.linkedin.com/in/vanisha-gupta-40305a294/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    linkedin.com/in/Vanisha-gupta
                  </a>
                </div>
                <div className="terminal-output">
                  <span className="icon">💻</span>{" "}
                  <a
                    href="https://github.com/Vanishagupta18"
                    target="_blank"
                    rel="noreferrer"
                  >
                    github.com/Vanishagupta18
                  </a>
                </div>
                <div className="terminal-output">
